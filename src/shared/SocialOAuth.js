...
// const REDIRECT_URI = "https://d389mk5b2t00ww.cloudfront.net/user/kakao/callback";
const REDIRECT_URI = "http://localhost:3000/user/kakao/callback";

// google Login
const GOOGLE_CLIENT_ID = process.env.REACT_APP_GOOGLE_ID;
// const GOOGLE_REDIRECT_URI = "https://d389mk5b2t00ww.cloudfront.net/user/google/callback";

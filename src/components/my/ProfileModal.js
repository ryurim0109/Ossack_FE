  ...
  const encodeFileToBase64 = (fileBlob) => {
    ...
    return (
        <React.Fragment>
            {isOpen ?
            (<Outter>
                <Grid width="100%" height="311px" padding="16px 0" bg="#fff" borderRadius="4px" position="relative">
                  <Grid  width="100%"  height="24px"display="flex" alignItems="center"  justifyContent="center" >
                    <Text bold size="1rem">프로필 이미지 변경</Text>
                  </Grid>
                <Button is_close position="absolute" right="16px" top="16px" _onClick={ModalClose}/>
                <Grid display="flex"  height="132px"flexDirection="column" alignItems="center" >
                    
                        <Grid width="132px" height="132px" margin="16px 0" display="flex" alignItems="center"  justifyContent="center" >
                        <Image
                    ...
                    <Grid width="100%" height="200px" display="flex" flexDirection="column" alignItems="center" justifyContent="center" >
